...
f=open("Test/HarryPotter.txt",encoding='UTF-8')
content = f.read()
f.close()
...
jieba.load_userdict("Test/Lib_HarryPotter_people.txt")#匯入自製人名字典


f=open("Test/HarryPotter_content_words.txt",'w',encoding='UTF-8')
